...
public class ItemSearchStoreAdapter extends BaseAdapter {

    ArrayList<StoreVO> list;
    StoreVO vo;
    StoreSearchActivity storeSearchActivity;

    public ItemSearchStoreAdapter(ArrayList<StoreVO> list, StoreSearchActivity storeSearchActivity) {
        this.list = list;
        this.storeSearchActivity = storeSearchActivity;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = View.inflate(storeSearchActivity, R.layout.item_my_like_store, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(storeSearchActivity, StoreInfoActivity.class);
